...
import com.iqlance.asaptemp.provider.utils.CustomTextView;
...
public class JobsAdapter extends RecyclerView.Adapter<JobsAdapter.ViewHolder> {
    ...
    public JobsAdapter(Context context, ArrayList<JobsModel> jobsModelArrayList, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_new_jobs, parent, false);
