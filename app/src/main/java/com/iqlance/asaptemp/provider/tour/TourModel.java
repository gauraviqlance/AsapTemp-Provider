...
public class TourModel extends BaseObservable implements Parcelable {
    ...
    public void setPic(int pic) {
        this.pic = pic;
        notifyPropertyChanged(com.iqlance.asaptemp.provider.BR.pic);
    }
    ...
    public void setTitle(String title) {
        title = title;
        notifyPropertyChanged(com.iqlance.asaptemp.provider.BR.title);
    }
    ...
    public void setMsg(String msg) {
        this.msg = msg;
        notifyPropertyChanged(com.iqlance.asaptemp.provider.BR.msg);
    }
